...
*
      ...
      ENTRY BXDRAW ( ICODE, MREG, NEWREG, XSCO, YSCO, ZSCO ) !Tracking crossings between regions
      
     
      IF (NEWREG .EQ. 2 .AND. MREG > 3) THEN !Photon goes from patient out to air, crossing events recorded
          WRITE(99,*) NCASE, ETRACK, -9999.0, 'NaN', XSCO, YSCO,  !The NaN and -9999.0 are placed as placeholders since crossing events don't have final energy or interaction type
     &  ZSCO, MREG, 'Crossing' !Writing crossing event to output		    
